...
enum host_status {
    ...
    USB_HOST_ATTACH,     
    USB_HOST_DISCONNECT,
    USB_HOST_MOUSE_CONNECT,
    USB_HOST_MOUSE_MOVE,
    USB_HOST_MOUSE_BUTTON_PRESSED,
    USB_HOST_MOUSE_BUTTON_RELEASED,
    USB_HOST_KBD_CONNECT,
    USB_HOST_MOUSE_IDLE
};
...
extern __IO enum host_status USB_Host_status;

extern int16_t mouse_event[3];
...
int USBH_USR_HID_Application(void);
